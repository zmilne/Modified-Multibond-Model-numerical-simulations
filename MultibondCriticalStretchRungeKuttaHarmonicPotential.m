...
function [meanFf maxFf stdFf TNotBonded NoiseParamSub NoiseParamCant firstSlipforce]=MultibondCriticalStretch(v,v2,T,GamSub,GamCant,ender,NoiseMult,n,ksub,kcant,timeStep,aTimes)
clc
